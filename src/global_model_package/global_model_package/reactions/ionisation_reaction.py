...
class Ionisation(Reaction):
    ...
    @classmethod
    def from_concatenated_txt_file(cls, species: Species, molecule_name_before: str, molecule_name_after:str, file_name: str, reaction_name, chamber) -> list[Self]:
        """
        ...
        file_path = os.path.join(ReactionRateConstant.CROSS_SECTIONS_PATH, molecule_name_before, file_name+".txt")
