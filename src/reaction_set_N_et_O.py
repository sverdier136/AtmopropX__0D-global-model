...
def get_species_and_reactions(chamber):
    ...
    species_list = Species([Specie("e", m_e, -e, 0, 0), Specie("N_2", 4.65e-26, 0, 2, 7/2), Specie("N", 2.33e-26, 0, 1, 3/2), Specie("N_2+", 4.65e-26, e, 2, 7/2), Specie("N+", 2.33e-26, e, 1, 3/2), Specie("O_2+", 5.31e-26, e, 2, 7/2), Specie("O_2", 5.31e-26, 0, 2, 7/2), Specie("O", 2.67e-26, 0, 1, 3/2), Specie("O+", 2.67e-26, e, 1, 3/2)])
