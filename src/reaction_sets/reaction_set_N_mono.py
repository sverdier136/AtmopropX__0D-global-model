...
def get_species_and_reactions(chamber):
    ...
    species = Species([Specie("e", m_e, -e, 0, 3/2), Specie("N", 2.33e-26, 0, 1, 3/2),  Specie("N+", 2.33e-26, e, 1, 3/2)])
...
#  ▄▀  ▄▀▄ ▄▀▀   █ █▄ █   █ ██▀ ▄▀▀ ▀█▀ █ ▄▀▄ █▄ █
#  ▀▄█ █▀█ ▄██   █ █ ▀█ ▀▄█ █▄▄ ▀▄▄  █  █ ▀▄▀ █ ▀█
    injection_rates = compression_rate * np.array([0.0, 5e14, 0.0]) #, 1e10, 2e13, 1e15, 1e10] #à revoir
