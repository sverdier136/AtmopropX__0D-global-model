...
ion01_N2 = Ionisation(species_list, ["N2"], ["N2+"], get_K_func(species_list, "N2", "ion01_N2"), 15.60, [1., 1., 1.])
...
ion01_N = Ionisation(species_list, ["N"], ["N+"], get_K_func(species_list, "N", "ion01_N"), 14.80, [1., 1., 1.])
ela_N = ElasticCollisionWithElectron(species_list, ["N"], get_K_func(species_list, "N", "ela_N"), 0)
# dion_N2 = Reaction(species_list, ["N2"], ["N", "N+", "e"], get_K_func(species_list, "N2", "dion_N2"), 18.00, [1., 1., 1., 1.]) Hassoul 
